...
const ApiErrorState = ({ error, message, onRetry }: ApiErrorStateProps) => (
    <div className="scanner-error-state" role="alert" data-testid="api-error-state" data-error-code={error.code}>
        <p className="scanner-error-state__message">{message ?? getErrorMessage(error)}</p>
        <p className="scanner-error-state__code">
            {error.code}
