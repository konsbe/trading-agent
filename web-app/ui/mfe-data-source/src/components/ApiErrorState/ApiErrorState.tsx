...
const ApiErrorState = ({ error, message, onRetry }: ApiErrorStateProps) => (
    <div className="data-source-error-state" role="alert" data-testid="api-error-state" data-error-code={error.code}>
        <p className="data-source-error-state__message">{message ?? getErrorMessage(error)}</p>
        <p className="data-source-error-state__code">
            {error.code}
