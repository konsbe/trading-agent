...
const ApiErrorState = ({ error, message, onRetry }: ApiErrorStateProps) => (
    <div className="watchlist-error-state" role="alert" data-testid="api-error-state" data-error-code={error.code}>
        <p className="watchlist-error-state__message">{message ?? getErrorMessage(error)}</p>
        <p className="watchlist-error-state__code">
            {error.code}
