...
const ApiErrorState = ({ error, message, onRetry }: ApiErrorStateProps) => (
    <div className="backtest-lab-error-state" role="alert" data-testid="api-error-state" data-error-code={error.code}>
        <p className="backtest-lab-error-state__message">{message ?? getErrorMessage(error)}</p>
        <p className="backtest-lab-error-state__code">
            {error.code}
