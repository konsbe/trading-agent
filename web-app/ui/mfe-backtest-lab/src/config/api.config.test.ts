import { BACKTEST_LAB_ENDPOINTS, DEFAULT_MOMENTUM_API_URL, getMomentumApiBaseUrl } from './api.config';
...
describe('api.config', () => {
    ...
    it('builds the report path', () => {
        expect(BACKTEST_LAB_ENDPOINTS.report).toBe('/api/v1/backtest-lab/report');
    });
});
