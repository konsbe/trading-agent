import { MARKET_REPORT_ENDPOINTS, DEFAULT_MOMENTUM_API_URL, getMomentumApiBaseUrl } from './api.config';
...
describe('api.config', () => {
    ...
    it('builds the report path', () => {
        expect(MARKET_REPORT_ENDPOINTS.today).toBe('/api/v1/market-report/today');
    });
});
